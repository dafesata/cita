class Paciente < ActiveRecord::Base
	...
	before_destroy :destroy_citas, :destroy_encuesta, :destroy_historia, :destroy_evolucion
	...
	def destroy_citas
   	...
   	def destroy_historia
     	Historium.where(:paciente_id => self.numero_id ).destroy_all  
   	end

   	def destroy_evolucion
   		Evolucion.where(:paciente_id => self.numero_id ).destroy_all 
   	end
end
