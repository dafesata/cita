Rails.application.routes.draw do
  ...
  get 'medpo/searchmedpo'

  get 'procpo/searchprocpo'

  get 'cie10/searchcie10'
  ...
  resources :evolucions do
    get :list, on: :collection
    get :export, on: :collection 
  end

  resources :historia do
    get :list, on: :collection
    get :export, on: :collection 
  ...
  resources :especialidads do
    get :list, on: :collection
    get :export, on: :collection
    get :searchespecialidad, :on => :collection
  end
  resources :profesionals do
    get :list, on: :collection
    get :export, on: :collection
    get :searchprofesional, :on => :collection
  end
